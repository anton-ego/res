...
$UserNameSamanage = "username"

#Generated (with ConvertTo-SecureString etc) password hash, stored in Automation variable 
$PasswordSamanage = "^[SecurePassword]"

#Secure encryption key, to have ability to use SecurePassword on all computers. Stored in Automation variable, like  (3,4,2,6,56,38,254,232,1,1,2,23,42,54,33,233,1,34,2,7,6,5,35,43)
$SecureKey= ^[SecureKey]
